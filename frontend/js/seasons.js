/* =========================================================================
   ...
   seasons.js — season cover page, trailer button, episode grid, load-more
   ========================================================================= */
...
(() => {
  ...
  async function init() {
    ...
    try {
      ...
      showError("Unable to load this season.");
  ...
  function renderCover(season) {
    ...
    const trailerBtn = document.querySelector("[data-cover-trailer]");
    ...
    if (watchBtn) {
      ...
      watchBtn.href =
        `/player.html?season=${season.id}&episode=1`;
    }
    ...
    if (trailerBtn) {
      ...
      if (season.trailer_url) {
        ...
        trailerBtn.href =
          `/player.html?season=${season.id}&trailer=1`;
  ...
  function renderEpisodesFirstPage(season) {
    ...
    const grid =
      document.querySelector("[data-episode-grid]");

    const rangeLabel =
      document.querySelector("[data-range-label]");
  ...
  function renderNextPage(
    ...
    if (rangeLabel) {
      ...
      rangeLabel.textContent =
        `Episodes 1–${state.rendered} of ${episodes.length}`;
    }
    ...
    if (loadMoreBtn) {
      ...
      loadMoreBtn.style.display =
        state.rendered >= episodes.length
          ? "none"
          : "";
    }
  ...
  function wireActions(season) {
    ...
    const scrollBtn =
      document.querySelector("[data-scroll-episodes]");
    ...
    if (scrollBtn) {
      ...
      scrollBtn.addEventListener("click", () => {
        ...
        document
          .querySelector("[data-episode-grid]")
          ?.scrollIntoView({
            behavior: "smooth",
            block: "start"
          });
